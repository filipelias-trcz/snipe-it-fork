...
return [
    ...
    'accessory_report'		=> 'Zpráva o příslušenství',
    'action'                => 'Akce',
    'action_date'			=> 'Datum provedení',
    'activity_report'		=> 'Report aktivity',
    'address'				=> 'Adresa',
    'admin'					=> 'Nastavení Admin uživatele',
    'admin_user'			=> 'Admin uživatel',
    'admin_tooltip'			=> 'Tento uživatel má Admin oprávnění',
    'superuser'				=> 'Super uživatel',
    'superuser_tooltip'		=> 'Tento uživatel má Super oprávnění',
    ...
    'asset_models'			=> 'Modely zařízení',
    'asset_model'			=> 'model',
    'asset'					=> 'Zařízení',
    'asset_previous'        => 'Zařízení (původně přiřazené)',
    'asset_report'          => 'Report zařízení',
    'asset_tag'				=> 'Označení zařízení',
    'asset_tags'            => 'Označení zařízení',
    'available'		        => 'Dostupný',
    'assets_available'		=> 'Dostupné zařízení',
    'accept_assets'         => 'Příjmout zařízení :name',
    'accept_assets_menu'    => 'Přijmout zařízení',
    'accept_item'           => 'Potvrdit převzetí položky',
    'accept_items'          => 'Potvrdit převzetí položek',
    'audit'				    => 'Audit',
    'audited'				=> 'Auditováno',
    ...
    'assets'				=> 'Zařízení',
    'assets_audited'        => 'zařízení, u nichž byl proveden audit',
    'assets_checked_in_count'     => 'zařízení zkontrolována v',
    'assets_checked_out_count'     => 'zařízení zkontrolována',
    'asset_deleted_warning'     => 'Toto zařízení bylo odstraněno. Musíte jej obnovit před tím, než jej budete moci někomu přiřadit.',
    ...
    'tag_color'  		    => 'Barva označení',
    'tag_color_help'  		=> 'Pokud si přejete použít vlastní barevné označení pro tuto položku, zadejte hexadecimální kód barvy (např. #ffffff pro bílou). Jinak můžete toto pole nechat prázdné.',
    'checkin'  				=> 'Převzít',
    'checkin_from'  		=> 'Převzít od',
    'checkin_note'  		=> 'Poznámka k převzetí',
    'checkout_note'  		=> 'Poznámka k výdeji',
    'checkout'  			=> 'Vydat',
    'checkouts_count'       => 'Vydání',
    'checkins_count'        => 'Převzetí',
    ...
    'created_asset'			=> 'vytvořit zařízení',
    ...
    'custom_report'         => 'Vlastní report zařízení',
    'dashboard'				=> 'Nástěnka',
    'data_source'           => 'Zdroj dat',
    'days'      			=> 'dnů',
    'days_to_next_audit'    => 'Dny do dalšího auditu',
    'date'					=> 'Datum',
    'debug_warning'         => 'Varování!',
    'debug_warning_text'    => 'Tato aplikace běží ve produkčním režimu s povoleným laděním. To znamená že citlivá data mohou být přístupná vnějšímu světu. Deaktivujte režim ladění nastavením hodnoty <code>APP_DEBUG</code> v souboru <code>.env</code> na <code>false</code>.',
    'delete'  				=> 'Odstranit',
    'delete_confirm'  		=> 'Opravdu chcete smazat :item?',
    'delete_confirm_no_undo' => 'Opravdu chcete smazat :item? Tuto akci nelze vrátit zpět.',
    'deleted'  				=> 'Odstraněno',
    ...
    'depreciation_report'	=> 'Report amortizace',
    'details'               => 'Podrobnosti',
    'download'				=> 'Stáhnout',
    ...
    'importing_help'        => 'Soubor CSV by měl být oddělený čárkou a měl by být formátován s hlavičkami, které odpovídají těm v <a href="https://snipe-it.readme.io/docs/importing" target="_new">ukázkových CSV v dokumentaci</a>.',
    ...
    'logout'				=> 'Odhlásit',
    'lookup_by_tag'     => 'Vyhledávání podle značky zařízení',
    'maintenances'          => 'Údržby',
    ...
    'model_no'				=> 'Modelové číslo',
    'months'				=> 'měsíce',
    'moreinfo'				=> 'Další informace',
    'name'					=> 'Název',
    'new_password'          => 'Nové heslo',
    'next'					=> 'Další',
    'next_audit_date'		=> 'Datum dalšího auditu',
    'next_audit_date_help'  => 'Pokud ve své organizaci používáte audit, je tato hodnota obvykle automaticky vypočtena na základě data posledního auditu zařízení a frekvence auditů (v <code>Nastavení administrátora &gt; Upozornění</code>) a můžete ji ponechat prázdnou. V případě potřeby můžete toto datum nastavit zde ručně, ale musí být pozdější než datum posledního auditu. ',
    'audit_images_help'     => 'Obrázky auditu najdete na kartě Historie zařízení.',
    ...
    'page_error'            => 'Předchozí stránka nebyla určena. Přesměrováno na domovskou stránku.',
    'pagination_info'		=> 'Zobrazuji od _START_ do _END_ z celkem _TOTAL_ položek',
    ...
    'restored'				=> 'obnoveno',
    'restore'				=> 'Obnovit',
    'requestable_models'    => 'Požadovatelné modely',
    ...
    'requested_assets'      => 'Vyžádané zařízení',
    ...
    'viewassets'  			=> 'Zobrazit přiřazené zařízení',
    ...
    'audit_due'             => 'počet zařízení čekajících na audit',
    ...
    'checkin_due'           => 'počet zařízení čekajících na vrácení',
    'checkin_overdue'       => 'Po termínu pro příjem',
    ...
    'add_all_users_to_group' => 'Přiřadit všechny uživatele do skupiny',
    ...
    'add_users_to_group_help'  => 'Použijte šipky pro přidání nebo odebrání uživatelů ze skupiny. Můžete vybrat více uživatelů podržením klávesy Ctrl (Windows) nebo Command (Mac) při klikání.',
    'fields'                => 'Pole',
    ...
    'report_fields_info'    => '<p>Vyberte pole, která chcete zahrnout do vlastní sestavy, a klepněte na tlačítko Generovat. Soubor (custom-asset-report-YYYY-mm-dd.csv) se stáhne automaticky a můžete jej otevřít v Excelu.</p>
            <p>Pokud chcete exportovat pouze některá zařízení, použijte níže uvedené možnosti pro úpravu výsledků.</p>',
    'range'                 => '(rozsah)',
    ...
    'asset_information'     => 'Informace o zařízení',
    'model_name'            => 'Model',
    ...
    'checkin_to_diff_location' => 'Můžete se rozhodnout, že toto zařízení zařadíte do jiného umístění, než je výchozí umístění tohoto zařízení :default_location, pokud je nastaveno',
    ...
    'shitty_browser'        => 'Nebyl zjištěn žádný podpis. Pokud používáte starší prohlížeč, použijte prosím modernější pro dokončení přijetí vašeho zařízení.',
    'bulk_soft_delete'      =>'Také odstranit tyto uživatele. Historie jejich zařízení zůstane neporušená/dokud tvrvale nevymažete smazané záznamy v nastavení správce.',
    ...
    'assets_by_status'      => 'Zařízení podle stavu',
    'assets_by_status_type'      => 'Zařízení podle typu stavu',
...
',
    ...
    'merge_information' =>  'Toto sloučí :count uživatele do jediného uživatele. Vyberte uživatele, do kterého chcete sloučit ostatní, a související zařízení, licence, atd bude přesunut k vybranému uživateli a ostatní uživatelé budou označeni jako smazané.',
    'warning_merge_information' => 'Tuto akci NELZE vrátit zpět a měla by být použita pouze v případě, že je potřeba sloučit uživatele kvůli chybnému importu nebo synchronizaci. Nezapomeňte nejdříve spustit zálohu.',
    ...
    'auto_incrementing_asset_tags_disabled_so_tags_required' => 'Generování automatického zvyšování značek zařízení je zakázáno, takže všechny řádky musí mít vyplněný sloupec "Značka zařízení".',
    'auto_incrementing_asset_tags_enabled_so_now_assets_will_be_created' => 'Poznámka: Generování auto-rostoucí značky zařízení je povoleno, takže zařízení budou vytvořena pro řádky, které nemají "Asset Tag". Řádky, které mají vyplněnou značku "Zařízení", budou aktualizovány s poskytnutými informacemi.',
    'send_welcome_email_to_users'   => ' Odeslat uvítací e-mail novým uživatelům',
    'send_welcome_email_help'   => 'Pouze uživatelé s platnou emailovou adresou a kteří jsou označeni jako aktivní obdrží uvítací e-mail, kde si mohou resetovat své heslo.',
    'send_welcome_email_import_help'   => ' Pouze noví uživatelé s platnou emailovou adresou a kteří jsou označeni jako aktivní ve vašem importním souboru obdrží uvítací e-mail, kde si mohou nastavit své heslo.',
    ...
    'error_user_company' => 'Liší se společnost majetku a společnost které se provádí výdej',
    'error_user_company_multiple' => 'Liší se jedna nebo více společnosti majetků a společnost které se provádí výdej',
    'error_user_company_accept_view' => 'Zařízení přiřazené vám patří jiné společnosti, takže ho nemůžete přijmout ani odmítnout, obraťtě se na vašeho nadřízeného nebo správce systému.',
    'error_assets_already_checked_out' => 'One or more of the assets are already checked out',
    'assigned_assets_removed' => ' Následující byly odstraněny z vybraných zařízení, protože jsou již vydány',
    'importer' => [
        'checked_out_to_fullname' => 'Vydáno: Celé jméno',
        'checked_out_to_first_name' => 'Vydáno: křestní jméno',
        'checked_out_to_last_name' => 'Vydáno: příjmení',
        'checked_out_to_username' => 'Vydáno: Uživatelské jméno',
        'checked_out_to_email' => 'Vydáno: E-mail',
        'checked_out_to_tag' => 'Vydáno: Značka zařízení',
        'manager_first_name' => 'Jméno nadřízeného',
        'manager_last_name' => 'Příjmení nadřízeného',
        'manager_full_name' => 'Celé jméno nadřízeného',
        'manager_username' => 'Uživatelské jméno nadřízeného',
        'manager_employee_num' => 'Zaměstnanecké číslo nadřízeného',
        'checkout_type' => 'Typ vydání',
        'checkout_location' => 'Vydání na umístění',
        ...
        'currency' => 'Měna',
        'address2' => 'Adresa 2',
        'import_note' => 'Importováno pomocí csv importéru',
    ],
    ...
    'checked_out_to_fields' => 'Údaje o vydání',
    'percent_complete' => '% hotové',
    'uploading' => 'Nahrávám... ',
    ...
    'rtd_location_help' => 'Toto je umístění zařízení, když se není vydáno',
    ...
    'no_requestable' => 'Neexistují žádné požadovatelné položky nebo modely zařízení.',

    'countable' => [
        'accessories'  => ':count Příslušenství |:count Příslušenství',
        'assets'  => ':count zařízení|:count zařízení',
    ...
    'show_inactive' => 'Vypršené nebo neaktivní',
    'show_expiring' => 'Budou vypršené nebo brzy neaktivní',
    ...
    'by' => 'Vytvořil',
    'by_user' => 'Vytvořil',
    'ldap_sync_location' => 'Synchronizovat všechny uživatele na toto umístění (Volitelné)',
    'version' => 'Verze',
    'build' => 'sestavení',
    'use_cloned_image' => 'Klonovat obrázek z originálu',
    'use_cloned_image_help' => 'Můžete klonovat originální obrázek nebo můžete nahrát nový pomocí pole pro nahrávání níže.',
    'use_cloned_no_image_help' => ' Tento předmět nemá přidružený obrázek a místo toho dědí z modelu nebo kategorie, ke které patří. Pokud byste chtěli použít specifický obrázek pro tento předmět, můžete níže nahrát nový.',
    ...
    'upload_deleted'        => 'Nahrané Smazané',
...
// Add form placeholders here
    ...
    'bulk_delete_associations' => [
        'general_assoc_warning'       => ':item_name stále má přidružené položky. Před smazáním tohoto :item je prosím odstraňte.',
        'assoc_assets'                => ':item_name je aktuálně přidružen k :asset_count zařízení(ím) a nelze jej smazat. Aktualizujte prosím svá zařízení tak, aby již na tento :item neodkazovala, a zkuste to znovu.',
        'asset_models'                => ':item_name je aktuálně přidružen k :asset_count zařízení(ím) a nelze jej smazat. Aktualizujte prosím své modely zařízení tak, aby již na tento :item neodkazovala, a zkuste to znovu.',
        'assoc_maintenances'          => ':item_name je aktuálně přidružen k :maintenance_count údržbám a nelze jej smazat. Aktualizujte prosím své údržby tak, aby již na tento :item neodkazovala, a zkuste to znovu.',
        'assoc_accessories'           => ':item_name je aktuálně přidružen k :accessory_count příslušenství a nelze jej smazat. Aktualizujte prosím své příslušenství tak, aby již na tento :item neodkazovala, a zkuste to znovu.',
        'assoc_consumables'           => ':item_name je aktuálně přidružen k :consumable_count spotřebnímu materiálu a nelze jej smazat. Aktualizujte prosím svůj spotřební materiál tak, aby již na tento :item neodkazoval, a zkuste to znovu.',
        'assoc_components'            => ':item_name je aktuálně přidružen k :component_count komponentě(ám) a nelze jej smazat. Aktualizujte prosím své komponenty tak, aby již na tento :item neodkazovaly, a zkuste to znovu.',
        'assoc_licenses'              => ':item_name je aktuálně přidružen k :license_count licenci(ím) a nelze jej smazat. Aktualizujte prosím své licence tak, aby již na tento :item neodkazovaly, a zkuste to znovu.',
        'assoc_assets_no_count'       => ':item_name je aktuálně přidružen k jiným zařízením a nelze jej smazat. Aktualizujte prosím svá zařízení tak, aby již na tento :item neodkazovala, a zkuste to znovu.',
        'asset_models_no_count'       => ':item_name je aktuálně přidružen k jiným modelům zařízení a nelze jej smazat. Aktualizujte prosím své modely zařízení tak, aby již na tento :item neodkazovala, a zkuste to znovu.',
        'assoc_maintenances_no_count' => ':item_name je aktuálně přidružen k jiným údržbám a nelze jej smazat. Aktualizujte prosím své údržby tak, aby již na tento :item neodkazovala, a zkuste to znovu.',
        'assoc_accessories_no_count'  => ':item_name je aktuálně přidružen k jinému příslušenství a nelze jej smazat. Aktualizujte prosím své příslušenství tak, aby již na tento :item neodkazovalo, a zkuste to znovu.',
        'assoc_consumables_no_count'  => ':item_name je aktuálně přidružen k jinému spotřebnímu materiálu a nelze jej smazat. Aktualizujte prosím svůj spotřební materiál tak, aby již na tento :item neodkazoval, a zkuste to znovu.',
        'assoc_components_no_count'   => ':item_name je aktuálně přidružen k jiným komponentám a nelze jej smazat. Aktualizujte prosím své komponenty tak, aby již na tento :item neodkazovaly, a zkuste to znovu.',
        'assoc_licenses_no_count'     => ':item_name je aktuálně přidružen k jiným licencím a nelze jej smazat. Aktualizujte prosím své licence tak, aby již na tento :item neodkazovaly, a zkuste to znovu.',
    ],
    ...
    'file_upload_status' => [
        ...
        'upload' => [
            'success' => 'Soubor byl úspěšně nahrán |:count soubory byly úspěšně nahrány',
            'error' => 'Nepodařilo se nahrát soubor |:count soubory se nepodařilo nahrát',
        ],
        
        'delete' => [
            'success' => 'Soubor byl úspěšně smazán |:count soubory byly úspěšně smazány',
            'error' => 'Nepodařilo se smazat soubor |:count soubory se nepodařilo smazat',
        ],
        ...
        'nofiles' => 'Nebyl vybrán žádný soubor pro nahrání',
        'confirm_delete' => 'Opravdu chcete tento soubor smazat?',
    ],
    ...
    'months_plural' => '1 měsíc|:count měsíce/ů',
